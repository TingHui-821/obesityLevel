...
.stApp {
    background: linear-gradient(180deg, #FBF7EF 0%, #FDF6F4 55%, #FBF7EF 100%);
}

/* ---- Hero banner (matcha -> strawberry swirl) ---- */
.hero-banner {
...
/* ---- Bordered input cards (Personal / Eating habits / Lifestyle) ---- */
div[data-testid="stVerticalBlockBorderWrapper"] {
    border-color: #DCEAD6 !important;
    background-color: #FFFFFF;
}
</style>
"""
